...
void solve() {
	ipn;
	ll l, r, c, lmin = INT_MAX, rmax = INT_MIN, len_cost = INT_MAX, prev = INT_MAX, res_min = INT_MAX, res_max = INT_MAX, len = INT_MIN;
	while (n--) {
		ll ans = 0;
		cin >> l >> r >> c;
		if (l < lmin) {
