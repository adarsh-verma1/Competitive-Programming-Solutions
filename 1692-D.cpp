...
void solve() {
	ips;
	ipn;
	vi a{600, 60, 0, 10, 1};		// to convert hh:mm into minutes
	vi good{0, 70, 140, 210, 280, 350, 601, 671, 741, 811, 881, 951, 1202, 1272, 1342, 1412}; //palindrome timings in minutes

	int time = 0;
	FOR(5) time += int(s[i] - '0') * a[i];
